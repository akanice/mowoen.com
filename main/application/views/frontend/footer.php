						...
						<li class="js-accordeon-item footer-navigation__item col-md-3 col-6">
							...
							<ul class="js-accordeon-content" style="">
								...
								<li class="footer-navigation-item__container">
									...
									<p><i class="fa fa-map-marker"></i> <b>Miền Nam:</b> Số 307 Đường Liên Phường, Phường Phú Hữu, TP. Thủ Đức, TP HCM</p>
			...
			<div id="zalo-vr" class="button-contact">
				<div class="phone-vr">
					...
					<div class="phone-vr-img-circle">
						<a target="_blank" href="https://zalo.me/0813946789">				
							<img src="/assets/img/icon-zalo.png">
						</a>
					</div>
				</div>
				</div>
