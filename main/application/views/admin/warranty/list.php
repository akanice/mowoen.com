					...
					<div class="content">
						<div class="widget red">
                            ...
                            <form method="GET" action="<?=@$base?>">
                                <tr>
                                    <td></td>
                                    <td><input type="text" class="form-control" placeholder="Mã bảo hành" name="uid" value="<?=@$uid?>"></td>
                            ...
                            <?php if($list) foreach ($list as $item){ ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?=@$item->phone?></td>
                                    <td><?=@$item->address?></td>
                                    <td><?=@$item->product_name?> | <span class="text-success"><?=@$item->product_sku?></span></td>
                                    <td><?php echo date_format(date_create($item->create_time),"d/m/Y"); ?></td>
                                    <td><?php echo date_format(date_create($item->purchase_date),"d/m/Y"); ?></td>
                                    <td><?php echo date_format(date_create($item->expired_date),"d/m/Y"); ?></td>
