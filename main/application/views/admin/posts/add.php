				...
				<div class="card">
					<div class="content">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="<?=base_url('admin/news')?>">Quản lý bài viết</a>
							</li>
							<li class="active">
								Thêm mới bài viết
							</li>
				...
				<div class="card">
					...
					<div class="content">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="likes" value="36"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Mô tả ngắn</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="excerpt" rows="8"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nội dung</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control ckeditor" name="description" rows="20"></textarea>
                                </div>
                            </div>
							<div class="form-group">
