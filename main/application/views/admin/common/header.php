    ...
    <div class="sidebar" data-color="purple" data-image="<?=base_url('/assets/img/sidebar-4.jpg')?>">
		...
		<div class="sidebar-wrapper ps-container ps-theme-default ps-active-y" id="nml-sidebar">
			...
			<ul class="nav">
				...
				<li class="<?php if (($suffix_uri == 'qrcodes')) echo 'active';?>">
					...
					<div class="collapse <?php if (($suffix_uri == 'qrcodes')) echo 'in';?>" id="qrcode">
						<ul class="nav">
							<li class="<?php if ($suffix_uri == 'qrcodes' and (@$suffix_uri3 == 'add')) echo 'active'?>"><a href="<?=base_url('admin/qrcodes/add')?>">Thêm mới</a></li>
							<li class="<?php if ($suffix_uri == 'qrcodes') echo 'active'?>"><a href="<?=base_url('admin/qrcodes')?>">Danh sách</a></li>
						</ul>
					</div>
				</li>

				<li class="<?php if (($suffix_uri == 'warranty')) echo 'active';?>">
					<a href="<?=base_url('admin/warranty')?>">
