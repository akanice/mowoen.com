				...
				<div class="card">
					<div class="header">
						<?php 
							...
							$post_type = 'products';
						?>
						<h4 class="title">Sửa thông tin sản phẩm <a href="<?=base_url($type.'/'.$post_type.'/'.$products->alias)?>" class="btn btn-sm btn-fill btn-warning" target="_blank">Xem</a> <a href="<?=@base_url('admin/products/add/?type='.$type)?>" class="btn btn-sm btn-fill btn-success" target="_blank"><i class="fa fa-plus"></i> Thêm mới</a></h4>
					</div>
					<div class="content">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="videos" id="videos" value="<?=@$p_video_attach?>" />
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="videos_thumb" id="videos_thumb" value="<?=@$p_video_attach_thumb?>" />
