...
class Posts extends MY_Controller{
    ...
    public function index(){
        ...
        $total = $this->postsmodel->readCount(array('title'=>'%'.$this->input->get('name')));
        ...
        if($this->data['name'] != "" or $this->data['category'] != ''){
            $this->data['list'] = $this->postsmodel->getListPosts('post',$this->data['name'],$this->data['category'],$config['per_page'],$start);
        }else{
            $this->data['list'] = $this->postsmodel->getListPosts('post','','',$config['per_page'],$start);
        }
