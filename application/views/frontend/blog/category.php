						...
						<div class="post-wrapper d-flex justify-content-between align-items-end ratio43_square">
							...
							<div class="post-info">
								<div class="post-info-header d-flex justify-content-between align-items-center m-0">
									...
									<div class="post-meta-item post-likes"><span class="sl-wrapper"><a href="#" class="sl-button" title="Like"><span class="sl-icon liked"></span><span class="sl-count"><?=@$item->like?></span></a><span class="sl-loader"></span></span></div>
								</div>
