...
<nav class="navbar navbar-transparent navbar-absolute">
    <div class="container">    
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img src="<?=base_url('assets/img/logo_main.png')?>" width="180px"></a>
        </div>
...
<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" data-color="blue" data-image="<?=base_url('assets/img/full-screen-image-5.png')?>">   
    ...
    <div class="full-page-background" style="background-image: url('<?=base_url('assets/img/full-screen-image-5.png')?>"></div></div>                             
